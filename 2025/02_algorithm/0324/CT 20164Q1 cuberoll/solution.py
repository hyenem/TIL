...
* 주사위굴리기2를 분석했었는데, 이건 1이네
* 원래 주사위를 2차원 배열로 가져갔었는데,
    하드코딩하는 과정에서 1차원 배열이 훨씬 유리하다는 걸 알게되어 구현 방식을 바꿈
* 처음 풀때는 바닥면 복사하는 과정을 이해하기 어려웠는데, 이젠 문제 꼼꼼히 잘읽고 잘했네

[ 채크리스트 ]
[V] 하드코딩 한 부분 다시 한번 살펴보기
'''
