...
[ 성장한 점 ]
* 진행 방향을 훨씬 깔끔하게 참조함
전 : direction = [[], [(0,), (1,), (2,), (3,)], [(0, 2), (1, 3)], [(0, 1), (1,2), (2,3), (3,0)], [(0, 1, 2), (0, 1, 3), (0, 2, 3), (1,2,3)], [(0,1,2,3)]]
후 : direction = [0, (0,), (0, 2), (0, 1), (0, 1, 2), (0, 1, 2, 3)]
...
def btk(idx, acc):
    global ans
    if acc - max(N, M)*(K-idx)>=ans: return
    ...
    for d in range(4):
        stack = []
        minus = 0
        for dd in direction[n]:
            nd = (d+dd)%4

            dx, dy = dxdy[nd]
            nx, ny = x, y
            while 0<=nx+dx<N and 0<=ny+dy<M and arr[nx+dx][ny+dy]!=6:
                nx, ny = nx+dx, ny+dy
...
direction = [0, (0,), (0, 2), (0, 1), (0, 1, 2), (0, 1, 2, 3)]
